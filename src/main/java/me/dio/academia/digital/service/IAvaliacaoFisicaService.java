...
public interface IAvaliacaoFisicaService {
  /**
   *Serve para serve para criar e salvar uma Avaliação Física no banco de dados.
  ...
  /**
   * Serve para retornar uma Avaliação Física que está no banco de dados de acordo com seu Id.
